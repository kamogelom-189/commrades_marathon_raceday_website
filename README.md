...
- `docs/api-plan.pdf`: Detailed REST API endpoint specification mapping methods, routes, parameters, and roles.

## CI/CD Validation
This repository includes an automated GitHub Actions CI workflow (`.github/workflows/part1-ci.yml`) that automatically validates repository structure, document presence, and SQL syntax on every commit.
